...
re-exporting audio, or add `--json` for machine-readable output. To prevent
spreadsheet formula execution, CSV text beginning with `=`, `+`, `-`, `@`, tab,
or carriage return receives a leading apostrophe. JSON values remain unchanged.
