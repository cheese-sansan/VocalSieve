    ...
    <div className="app-shell">
      ...
      <main>
        <header className="topbar">
          ...
          <form className="token-form" onSubmit={(event) => void connect(event)}>
            <label>
              Session token
              <input
                type="password"
                ...
                placeholder="Paste the token printed by vocalsieve serve"
              />
            </label>
            <button className="primary" disabled={!sessionToken.trim()} type="submit">
              Connect
            </button>
            <button
